...
int nox_xxx_netOnPacketRecvServ_51BAD0_net_sdecode_switch(int a1, unsigned char* data, int dsz, nox_playerInfo* v8p, nox_object_t* unitp, void* v10p) {
	...
	case 0xEEu: // MSG_VOTE
		...
		case 0u:;
			...
			sub_506870(c1, unitp, (wchar2_t*)data + 1);
			return 52;
		case 1u:
			sub_506870(1, unitp, (wchar2_t*)data + 1);
			return 52;
		case 2u:;
			int c2 = 0;
			if (nox_common_gameFlags_check_40A5C0(4096)) {
			...
			sub_506C90(c2, unitp, (wchar2_t*)data + 1);
			return 52;
		case 3u:
			sub_506C90(1, unitp, (wchar2_t*)data + 1);
			return 52;
		case 4u:
			sub_506870(2, unitp, 0);
			return 2;
		case 5u:
			sub_506C90(2, unitp, 0);
			return 2;
		default:
			return -1;
		}
