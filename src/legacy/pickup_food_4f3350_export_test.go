...
func TestPickupFoodExport4F3350PreservesNativePointersFourArgumentsAndResult(t *testing.T) {
	...
	if got := pickupFoodExportCall4F3350(owner, item, math.MinInt32, math.MaxInt32); got != math.MinInt32 {
		t.Fatalf("first result = %d, want %d", got, int32(math.MinInt32))
	}
	if got := pickupFoodExportCall4F3350(owner, item, -17, -23); got != math.MaxInt32 {
