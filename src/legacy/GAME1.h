...
uint32_t nox_modifier_getDurability(void* modifier);
float nox_modifier_getArmor(void* modifier);
uint16_t nox_modifier_getRequiredStrength(void* modifier);
...
int32_t nox_modifier_effect_getPreHitInt(void* modifier);
float nox_modifier_effect_getPreHitFloat(void* modifier);
int32_t nox_modifier_effect_getPreDamageInt(void* modifier);
float nox_modifier_effect_getPreDamageFloat(void* modifier);
...
int nox_server_needPlayerStatus_4174F0(nox_playerInfo* player, int mask);
