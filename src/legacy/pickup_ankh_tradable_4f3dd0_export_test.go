...
func TestPickupAnkhTradableExport4F3DD0PreservesNativePointersFourArgumentsAndResult(t *testing.T) {
	...
	old := Nox_xxx_pickupAnkhTradable_4F3DD0
	t.Cleanup(func() { Nox_xxx_pickupAnkhTradable_4F3DD0 = old })
	calls := 0
	Nox_xxx_pickupAnkhTradable_4F3DD0 = func(gotOwner, gotItem *server.Object, arg3, arg4 int32) int32 {
		calls++
	...
	if got := pickupAnkhTradableExportCall4F3DD0(owner, item, math.MinInt32, math.MaxInt32); got != math.MinInt32 {
		t.Fatalf("first result = %d, want %d", got, int32(math.MinInt32))
	}
	if got := pickupAnkhTradableExportCall4F3DD0(owner, item, -17, -23); got != math.MaxInt32 {
...
func TestPickupAnkhTradableRegistration4F3DD0UsesExactFourArgumentCallback(t *testing.T) {
	owner, freeOwner := alloc.New(server.Object{})
	defer freeOwner()
	item, freeItem := alloc.New(server.Object{})
	defer freeItem()

	pickup, ok := server.ObjectPickupHandler("AnkhTradablePickup")
	if !ok || pickup.Ptr == nil {
		t.Fatal("AnkhTradablePickup callback is not registered")
	}
	old := Nox_xxx_pickupAnkhTradable_4F3DD0
	t.Cleanup(func() { Nox_xxx_pickupAnkhTradable_4F3DD0 = old })
	Nox_xxx_pickupAnkhTradable_4F3DD0 = func(gotOwner, gotItem *server.Object, arg3, arg4 int32) int32 {
