...
func init() {
	...
	legacy.Nox_xxx_createSpellFly_4FDDA0 = func(source, target *server.Object, spellID spell.ID) *server.Object {
		return noxServer.CreateSpellProjectile4FDDA0(source, target, spellID)
	}
	legacy.Nox_xxx_collide_4FDF90 = func(source, target *server.Object) {
		noxServer.CollisionEnchant4FDF90(source, target)
	}
	...
	legacy.Nox_xxx_pickupTrap_4F3510 = nox_xxx_pickupTrap_4F3510
	legacy.Nox_xxx_pickupTreasure_4F3580 = nox_xxx_pickupTreasure_4F3580
	legacy.Nox_objectPickupAudEvent_4F3D50 = nox_objectPickupAudEvent_4F3D50
	legacy.Nox_xxx_pickupAnkhTradable_4F3DD0 = nox_xxx_pickupAnkhTradable_4F3DD0
	...
	legacy.Nox_xxx_pickupAbilitybook_4F3CE0 = nox_xxx_pickupAbilitybook_4F3CE0
	...
	legacy.Nox_xxx_inventoryServPlaceRaw_4F36F0 = func(obj, it *server.Object, a3, a4 int32) int32 {
		return nox_xxx_inventoryServPlaceRaw_4F36F0(noxServer, obj, it, a3, a4)
	}
}
