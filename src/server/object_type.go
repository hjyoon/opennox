...
type serverObjTypes struct {
	...
	fast struct {
		...
		// GAME.EXE 004F7DF0 owns the next fixed-width GameBall type cache at
		// 0x7535FC. Keep it separate from unitIsGameBall_4E7C30 and every
		...
		rewardContainerMarker     uint32
		rewardContainerMarkerPlus uint32
