...
int sub_5485B0(nox_object_t* a1, nox_object_t* a2);
...
void sub_548830(uintptr_t data);
...
void nox_xxx_createFnAnim_54CA50(nox_object_t* obj);
...
void nox_xxx_dieBarrel_54DFA0(nox_object_t* a1);
