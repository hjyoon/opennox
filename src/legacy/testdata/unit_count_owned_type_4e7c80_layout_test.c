...
#ifdef NOX_UNIT_COUNT_OWNED_TYPE_4E7C80_NATIVE_LAYOUT
// Native probes suppress unrelated Win32-only assertions while defs.h is
// parsed, then re-enable exactly the fields and ABI consumed by 004E7C80.
...
static int32_t (*const nox_count_owned_type_signature_4e7c80)(nox_object_t*, int32_t) =
