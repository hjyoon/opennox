...
func questJournalQualifyExportCall5009B0(name string) uint32 {
	cname := C.CString(name)
	defer C.free(unsafe.Pointer(cname))
...
func questJournalReadExportCall500B70() int32 {
	return int32(C.sub_500B70())
}
