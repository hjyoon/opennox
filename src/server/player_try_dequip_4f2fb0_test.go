...
func TestPlayerTryDequip4F2FB0ArmorFallbackOrderAndNormalization(t *testing.T) {
	owner := new(Object)
	item := new(Object)
	for _, tc := range []struct {
		...
		{name: "maximum", armor: 0x7fffffff, result: 1},
...
func TestPlayerTryDequip4F2FB0ForwardsNilPointersWithoutGuard(t *testing.T) {
	var events []string
	got := PlayerTryDequip4F2FB0(
		nil,
		nil,
