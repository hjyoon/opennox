...
int sub_4C3A90(nox_window* win, int event, uintptr_t event_arg, uintptr_t event_arg2);
void sub_4C3B70();
...
int sub_4CBBB0();
void sub_4CBBF0();
int sub_4CBE70(nox_window* win, int event, uintptr_t event_arg, uintptr_t event_arg2);
