...
func nox_xxx_abilityGetName_0_425260(ca_cgo int32) *wchar2_t {
	ca := int(ca_cgo)
...
func nox_xxx_abilityCooldown_4252D0(ca_cgo int32) int32 {
	ca := int(ca_cgo)
	return int32(Nox_xxx_abilityCooldown_4252D0(ca))
}

//export sub_4252F0
func sub_4252F0(ca_cgo int32) *wchar2_t { ca := int(ca_cgo); return internWStr(Sub_4252F0(ca)) }

//export nox_xxx_spellGetAbilityIcon_425310
func nox_xxx_spellGetAbilityIcon_425310(abil_cgo, icon_cgo int32) *nox_video_bag_image_t {
	abil := int(abil_cgo)
	icon := int(icon_cgo)
...
func nox_xxx_bookNextKnownAbil_425350(a1_cgo int32) int32 {
	a1 := int(a1_cgo)
	return int32(Nox_xxx_bookNextKnownAbil_425350(a1))
}

//export sub_425450
func sub_425450(a1_cgo int32) int32 { a1 := int(a1_cgo); return int32(Sub_425450(a1)) }
