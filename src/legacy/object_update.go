...
func init() {
	...
	server.RegisterObjectUpdateGo("PushUpdate", C.nox_xxx_updatePush_53B030, func(obj *server.Object) {
		pushUpdateCall53B030(obj)
	}, unsafe.Sizeof(server.PushUpdateData53B030{}))
	...
	server.RegisterObjectUpdateGo("MonsterUpdate", C.nox_xxx_unitUpdateMonster_50A5C0, func(obj *server.Object) {
		Nox_xxx_unitUpdateMonster_50A5C0(obj)
	}, unsafe.Sizeof(server.MonsterUpdateData{}))
	...
	server.RegisterObjectUpdateGo("BlackPowderBurnUpdate", C.nox_xxx_updateBlackPowderBurn_53CCB0, func(obj *server.Object) {
		blackPowderBurnUpdateCall53CCB0(obj)
	}, 0)
	...
	server.RegisterObjectUpdateGo("DeathBallFragmentUpdate", C.nox_xxx_updateDeathBallFragment_53D220, func(obj *server.Object) {
		deathBallFragmentUpdateCall53D220(obj)
	}, 0)
	...
	server.RegisterObjectUpdateGo("SentryGlobeUpdate", C.nox_xxx_updateSentryGlobe_510E60, func(obj *server.Object) {
		sentryGlobeUpdateCall510E60(obj)
	}, unsafe.Sizeof(server.SentryUpdateData{}))
	...
	server.RegisterObjectUpdateGo("MeteorShowerUpdate", C.nox_xxx_updateMeteorShower_53D5A0, func(obj *server.Object) {
		meteorShowerUpdateCall53D5A0(obj)
	}, unsafe.Sizeof(server.MeteorUpdateData{}))
	server.RegisterObjectUpdateGo("MeteorUpdate", C.nox_xxx_meteorExplode_53D6E0, func(obj *server.Object) {
		meteorUpdateCall53D6E0(obj)
	}, unsafe.Sizeof(server.MeteorUpdateData{}))
	server.RegisterObjectUpdateGo(
		"ToxicCloudUpdate",
