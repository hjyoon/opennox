...
static unsigned int observed_seeds[8];
...
int main(void) {
	...
	assert(observed_seeds[4] == UINT32_C(0x143D));
	assert(observed_seeds[5] == UINT32_C(0x22EA));
	assert(observed_seeds[6] == UINT32_C(0x22EB));
	assert(observed_seeds[7] == UINT32_C(0x1446));
	return 0;
}
