...
nox_team_t* sub_418A40(wchar2_t* a1);
...
void sub_4214D0();
int nox_xxx_polygon_421660(int* a1, void* polygon);
...
int sub_421880(int2* point, void* polygon, float a3);
...
int sub_427DF0(int2* point, int* line, float a3);
