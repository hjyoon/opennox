...
typedef int32_t (*default_xfer_fn_4F49A0)(nox_object_t*, void*);

_Static_assert(CHAR_BIT == 8, "serialized bytes must remain eight bits");
_Static_assert(sizeof(void*) == 4 || sizeof(void*) == 8, "unsupported pointer width");
_Static_assert(sizeof(int32_t) == 4, "DefaultXfer result must remain int32");
_Static_assert(
	_Generic(&nox_xxx_XFerDefault_4F49A0, default_xfer_fn_4F49A0: 1, default: 0),
	"DefaultXfer must preserve two native pointers and its exact int32 result");

static nox_object_t* observed_object;
static void* observed_context;

int32_t nox_xxx_XFerDefault_4F49A0(nox_object_t* object, void* context) {
...
int main(void) {
	...
	default_xfer_fn_4F49A0 const transfer = nox_xxx_XFerDefault_4F49A0;
