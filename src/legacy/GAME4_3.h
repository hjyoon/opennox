...
void sub_533EB0(nox_object_t* missile, void* unit);
...
void nox_xxx_updateWaterBarrel_53CB90(nox_object_t* a1);
...
int32_t nox_xxx_useLesserFireballStaff_53F290(nox_object_t* owner, nox_object_t* wand);
int32_t nox_xxx_useWandCastSpell_53F4F0(nox_object_t* owner, nox_object_t* wand);
int32_t nox_xxx_useFireWand_53F670(nox_object_t* owner, nox_object_t* wand);
...
int32_t nox_xxx_useSpellReward_53F9E0(nox_object_t* owner, nox_object_t* item);
