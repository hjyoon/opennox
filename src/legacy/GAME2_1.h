...
nox_drawable* sub_461600(int a1);
...
int sub_463370(nox_window* win, nox_point* pos, uint32_t* a3);
...
nox_drawable* nox_client_inventory_get_dragged(void);
void nox_client_inventory_set_dragged(nox_drawable* drawable);
int nox_client_inventory_animation_state(void);
int nox_client_inventory_animation_offset(void);
int nox_client_inventory_has_dragged(void);
...
int nox_xxx_cliDrawMinimap_472600(nox_drawable* dr, int a2);
